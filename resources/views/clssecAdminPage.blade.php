...
<table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        <td>{{$std->id}}</td>
        <td>
          {{ $std->name }} = {{ $std->remarks }}
        </td>
        <td>
					New Admission = {{ $cls->name }}
				</td>
        ...
        <td>
						<a href="{{url('/issueRollByValue',	[$std->id, 0, $std->stclss_id, $std->stsec_id, $std->remarks])}}" class="btn btn-warning issue-roll" id="btnSubmit">Issue Roll by Value</a>
            <!-- <a href="{{url('/issueRoll',				[$std->id, 0, $std->stclss_id, $std->stsec_id])}}" class="btn btn-info issue-roll" id="btnSubmit">Issue Roll Auto</a> -->
        </td>
      </tr>
      @endforeach
...
<table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        <td>{{$std->id}}</td>
        <td>
          {{ $std->studentdb->name }} = {{ $std->studentdb->name }}
