    ...
    {{--  <div class="panel-body">
      ...
      @foreach($clsses as $clss)
        <tr id="tr{{$clss->id}}">
          ...
          <td>{{ $clss->session_id }}</td>
          <td>
              <button class="btn btn-success btn-sm btnEdit" data-id="{{$clss->id}}" data-toggle="modal" data-target="#editModal">Edit</button>
              <button  class="btn btn-danger btn-sm btnDelt" data-id="{{$clss->id}}" data-toggle="modal" data-target="#deleteModal">Delete</button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      {!! Form::open(['url'=>'/clsses-submit','method'=>'post', 'class'=>'form-horizontal']) !!}
      ...
      <div class="modal-body">        
        	...
        	<label class="control-label col-sm-4" for="clssName">Enter New Class Name:</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="clssName" name="clssName" placeholder="enter new class name">
					</div>         
      	</div>
