  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">        
        	...
        	<label class="control-label col-sm-4" for="extypeName">Enter New Exam Name:</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="extypeName" name="extypeName" placeholder="enter new exam type name">
					</div>         
      	</div>
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">        
				...
				<div class="form-group">
        	<label class="control-label col-sm-4" for="editclssName">Enter New Exam Type Name:</label>
					<div class="col-sm-6">
